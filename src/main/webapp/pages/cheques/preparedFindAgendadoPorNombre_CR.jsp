...
<jsp:include page="../add_on/botones_basicos.jsp"/>
	<s:form id="findProveedorForm" action="findAgendadoPorNombre_CR" theme="simple" cssClass="inline" method="post" >		
		<div class="panel_100 tab">
	    	<div class="space"></div>
		
		<fieldset class="defaultFieldset" >
		<legend><b>Cheques Rechazados - Busqueda por Agendado</b></legend>

	...
	border="0"></img> </a>
		   	...
		   	<fieldset class="defaultFieldset">
    			...
    			<table>
 				...
 				<tr>
					<td align="left">
	 					<label class="label_33 field">Fecha Desde:</label>	 	 						 									
	 					<b><s:label id="fechaDesde" name="fechaDesde"/></b>					
		 			</td>
		 			<td align="left">
	 					<label class="label_33 field">Fecha Hasta:</label>	 				
						<b><s:label id="fechaHasta" name="fechaHasta" /></b>					
					</td>
				...
				<tr>
					<td align="left">
	 					...
	 					<label for="saldoAnterior" class="label_33 field">Saldo Anterior:</label>	 					 					
	 					<b><s:label id="saldoAnterior" name="saldoAnterior" /></b>				
				...
				<div class="space"></div> 
						<label for="totalSaldo" class="label_33 field">Total Saldo:</label>	 					 					
	 					<b><s:label id="totalSaldo2" name="totalSaldo" /></b>

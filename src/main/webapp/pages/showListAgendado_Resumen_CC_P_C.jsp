	...
	<div class="panel_100 tab">
	    	<div class="space"></div>
           	...
           	<fieldset class="defaultFieldset">
    			<legend><b>Pedido de Compra - Agendados</b></legend>
    			<div class="space"></div>
				<s:actionerror/>	
					<ec:table					
						tableId="notReg" 
						...
						var = "gente"
						locale="es_ES"
						action="findAgendadoPorNombre_Resumen_CC_P_C"
...
<s:form action="getPedidoDeCompraPorGente_CC" id="findSoloImpagosPorGenteForm">

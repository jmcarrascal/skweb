		...
		<div class="panel_100 tab">
	    	<div class="space"></div>
           	<fieldset class="defaultFieldset">
    			<legend><b>Articulos por Articulo Madre</b></legend>
    			<div class="space"></div>				
						
						<label for="familia" class="label_33 field">Articulo Madre:</label>	 					 					
	 					<b><s:label id="gente.razonSocial" name="artMadre.descArtMad" /></b>
					...
					<ec:table					
						...
						var = "articulo"
						locale="es_ES"
						action="showListArticulosPorArtMadre"

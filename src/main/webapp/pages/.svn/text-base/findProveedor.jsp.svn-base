...
<jsp:include page="add_on/botones_basicos.jsp"/>
	<s:form id="findProveedorForm" action="findProveedorPorNombre" theme="simple" cssClass="inline" method="post" >		
		<fieldset class="defaultFieldset" >
		<legend><b>Consulta de Stock - Busqueda de Proveedor por Nombre</b></legend>

...
<jsp:include page="add_on/botones_basicos.jsp"/>
	<s:form id="findProveedorForm" action="findGentePorNombre_CC_C" theme="simple" cssClass="inline" method="post" >		
		<fieldset class="defaultFieldset" >
		<legend><b>Solo Impagos - Busqueda por Agendado</b></legend>
